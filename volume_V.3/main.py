...
width_vector = str(args["width"])
height_vector = str(args["length"])
width_vector = [float(w_value) for w_value in width_vector.split(",")]
height_vector = [float(h_value) for h_value in height_vector.split(",")]
...
for shape,w_calib,h_calib in zip(shapes,width_vector,height_vector):
    # volume variable
    volume = list()
